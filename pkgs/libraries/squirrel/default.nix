...
let
  SQUIRREL_VERSION = "3.0.7";
in stdenv.mkDerivation {
  name = "squirrel";

  src = fetchurl {
    url = "http://sourceforge.net/projects/squirrel/files/squirrel_${lib.replaceChars ["."] ["_"] SQUIRREL_VERSION}_stable.tar.gz";
  ...
  patches = [
    (fetchurl {
      url = "https://raw.githubusercontent.com/pspdev/psplibraries/9d4afd89ee8983e647e9207a8d738159aceb35ef/patches/squirrel-${SQUIRREL_VERSION}.patch";
