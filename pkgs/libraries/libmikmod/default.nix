...
in stdenv.mkDerivation {
  ...
  src = fetchurl {
    url = "https://downloads.sourceforge.net/mikmod/libmikmod-${LIBMIKMOD_VERSION}.tar.gz";
  ...
  patches = [
    (fetchurl {
      url = "https://raw.githubusercontent.com/pspdev/psplibraries/9d4afd89ee8983e647e9207a8d738159aceb35ef/patches/libmikmod-${LIBMIKMOD_VERSION}-PSP.patch";
