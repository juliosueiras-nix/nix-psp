...
in stdenv.mkDerivation {
  ...
  src = fetchurl {
    url = "http://sourceforge.net/projects/libpng/files/libpng15/older-releases/${LIBPNG_VERSION}/libpng-${LIBPNG_VERSION}.tar.gz";
  ...
  patches = [
    (fetchurl {
      url = "https://raw.githubusercontent.com/pspdev/psplibraries/9d4afd89ee8983e647e9207a8d738159aceb35ef/patches/libpng-${LIBPNG_VERSION}-PSP.patch";
