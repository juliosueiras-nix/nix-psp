...
let ZLIB_VERSION = "1.2.8";
in stdenv.mkDerivation {
  name = "zlib";

  src = fetchurl {
    url =
      "http://sourceforge.net/projects/libpng/files/zlib/${ZLIB_VERSION}/zlib-${ZLIB_VERSION}.tar.gz";
  ...
  patches = [
    (fetchurl {
      url =
        "https://raw.githubusercontent.com/pspdev/psplibraries/9d4afd89ee8983e647e9207a8d738159aceb35ef/patches/zlib-${ZLIB_VERSION}-PSP.patch";
